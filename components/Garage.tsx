    ...
    <div className="flex flex-col h-full max-w-lg mx-auto p-4 animate-fadeIn">
      ...
      <div className="relative bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl p-6 border border-white/10 mb-4 shadow-2xl">
        ...
        <div className="flex justify-between items-center mb-4 relative z-10">
            <button onClick={handlePrevCar} className="p-2 hover:bg-white/10 rounded-full transition"><ChevronLeft /></button>
            ...
            <button onClick={handleNextCar} className="p-2 hover:bg-white/10 rounded-full transition"><ChevronRight /></button>
        </div>
